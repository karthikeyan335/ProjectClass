...
public class BaseClass {
	...
	// alert
	public static String alert(String name, String s) {

		if(name.equalsIgnoreCase("simpleAlert")) {
			Alert a = driver.switchTo().alert();
			a.accept();
	    }
		else if(name.equalsIgnoreCase("confirmAlert")) {
			Alert a = driver.switchTo().alert();
			a.dismiss();
		}
		else if(name.equalsIgnoreCase("promptAlert")) {
			Alert a = driver.switchTo().alert();
			a.sendKeys(s);
			a.accept();
		}
	...
	public static void screenShot(String screenName) throws IOException {
		...
		File dec=new File(System.getProperty("user.dir")+"\\src\\test\\resources\\Screenshot\\"+screenName+".png");
